...
async function cargarProveedores() {
  ...
  try {
    ...
    lista.addEventListener("edit-proveedor", (e) => editarProveedor(e.detail.id));
    lista.addEventListener("delete-proveedor", (e) => eliminarProveedor(e.detail.id));
  } catch (error) {
...
function mostrarFormularioProveedor(proveedor = null) {
...
async function editarProveedor(id) {
  try {
    ...
    mostrarFormularioProveedor(proveedor);
  } catch (error) {
